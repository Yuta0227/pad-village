...
@section('content')
    ...
    <section id="post_trade_form_section" style="z-index:100;height:100vh;overflow-y:scroll;position:fixed;overscroll-behavior-y:none;" class="hidden bg-blue-50 w-full">
        ...
        <form action="/boards/trade" method="POST">
            ...
            <textarea name="description" rows="8">@if (session()->has('description'))
